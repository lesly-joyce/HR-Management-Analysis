...
## Features
- Analysis of terminated employees by department, position, and tenure.
- Temporal analysis of employee terminations over time.
- Comparison of manager performance with attrition rate.
- Reasons for employee terminations.

## Files
- `HR_report.pbix` - The Power BI report file.

## How to Use
1. Download the `.pbix` file.
2. Open it in Power BI Desktop.
3. Explore the visualizations and analyses based on the dataset.
